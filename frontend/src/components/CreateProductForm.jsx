...
const CreateProductForm = () => {
  ...
  return (
    ...
    >
      <h2 className='text-2xl font-semibold mb-6 text-emerald-300'></h2>
      ...
      <form onSubmit={handleSubmit} className='space-y-4'>
        <div>
          ...
          text-focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500'
            required
          ></input>
        </div>
...
rounded-md shadow-sm text-sm leading-4 font-medium text-gray-300
