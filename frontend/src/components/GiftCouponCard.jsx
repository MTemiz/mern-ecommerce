...
const GiftCouponCard = () => {
    ...
    const { coupon, isCouponApplied, applyCoupon,
        getMyCoupon, removeCoupon } = useCartStore();
        ...
        >
            <div className="space-y-4">
                <div>
                    ...
                    p-2.5 text-sm text-white placeholder-gray-400 focus:border-emerald-500 focus:ring-emerald-500"
            ...
            {isCouponApplied && coupon && (
                <div className="mt-4">
                    ...
                    <motion.button
                        type="button"
                        className="flex w-full items-center justify-center rounded-lg bg-red-600 px-5 py-2.5 text-sm
